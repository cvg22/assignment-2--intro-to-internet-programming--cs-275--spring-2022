...
function ricechoice() {
  ...
  if (eleccion === 'whiterice') {
    document.getElementById("opciones").innerHTML = document.getElementById("whiterice").innerHTML;
    white = true;
    inrice.value = "";
    outwater.value = "";
  }
  else {
    document.getElementById("opciones").innerHTML = document.getElementById("sproutedcaliforniarice").innerHTML;
    white = false;
    inrice.value = "";
    outwater.value = "";
  }
